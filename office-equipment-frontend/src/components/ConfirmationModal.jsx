...
const ConfirmationModal = ({
    ...
    const typeStyles = {
        ...
        primary: {
            ...
            confirmBtn: 'bg-primary-600 hover:bg-primary-700 text-white shadow-primary-200 dark:shadow-none',
        }
    };
                ...
                <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-2xl text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="px-6 pt-8 pb-6">
                        <div className="sm:flex sm:items-start">
                            <div className={`mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-xl ${currentStyle.iconBg} sm:mx-0 sm:h-10 sm:w-10`}>
                    ...
                    <div className="px-6 py-4 bg-gray-50 dark:bg-gray-900/50 flex flex-col sm:flex-row-reverse gap-3">
                        <button
                            ...
                            className={`inline-flex justify-center w-full px-4 py-2.5 rounded-xl text-sm font-bold transition-all duration-200 shadow-lg ${currentStyle.confirmBtn}`}
                        >
                            {confirmText}
                        </button>
                        <button
                            type="button"
                            onClick={onClose}
                            className="inline-flex justify-center w-full px-4 py-2.5 rounded-xl text-sm font-bold text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200"
                        >
                            {cancelText}
                        </button>
                    </div>
